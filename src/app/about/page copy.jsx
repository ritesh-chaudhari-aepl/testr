...
import googleMata from "@/assets/gallery/google-mata.png";
import motorBaba from "@/assets/gallery/motor-baba.png";
import bhompooSwami from "@/assets/gallery/bhompoo-swami.png";
...
import radha from "@/assets/gallery/Radha1.jpg";
import radha1 from "@/assets/gallery/radha.png";
      ...
      <div className="max-w-screen-xl px-8 mx-auto py-8 mb-4">
        ...
        <div className="flex flex-col border-b mb-4 pb-6 lg:flex-row gap-2 ">
          <div className="characters grid gap-4">
            ...
            <div className="hidden lg:grid grid-cols-1">
              <div>
                <div className="flex flex-col items-center mt-6">
                  ...
                  <p className="p-2 w-full font-sans flex justify-start font-medium text-xl">
                  ...
                  <div className="relative grid grid-cols-1 cursor-pointer rounded-md bg-white">
                    <div className="relative h-full overflow-y-auto scrollbar">
                      <div className="mt-4 md:mt-0">
                        <div className="">
                          <div className="text-justify">
                            <p className="p-2 font-sans text-xl leading-normal">
                              The supporting characters of “Radha and the Great
                              Rescue” represent immense and rich opportunities
                              for the right actors. We envision being able to
                              secure actors who will be able to bring each of
                              these characters to life in an original and unique
                              way. We see these roles being able to be filled by
                              known and loved actors, up-and-coming talent, or
                              as unknowns specifically cast for the unique look
                              and feel they bring to screen.
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="grid grid-cols-1 gap-8 w-full">
                <div className="flex flex-col items-center mt-6">
                  ...
                  <div className="grid grid-cols-1 md:lg:grid lg:flex gap-2">
                    <div>
                      <p className="p-2 font-sans text-xl leading-normal font-medium">
            ...
            <div className="lg:hidden grid grid-cols-1 gap-2">
              {/* 1 */}
              <AboutCardsMob
                h3headline="Radha - Saregama Lil’ Champ sensation Dnyaneshwari Gadage is Radha"
            ...
            <div className="border-r lg:hidden grid grid-cols-1">
              <div>
                <div className="flex flex-col items-center mt-6">
                  <div className="flex px-2 pt-2 gap-3 ml-5 w-full items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="10"
                      height="12"
              ...
              <div>
                <div className="flex flex-col items-center mt-6">
                  <div className="flex px-2 pt-2 gap-3 w-full items-center">
                    ...
                    <h3 className="font-medium font-WhitneySemibold capitalize text-lg">
                      Dnyaneshwari Gadage as “Radha” ( Main Lead )
                    </h3>
                  </div>
            ...
            <div className="lg:hidden grid grid-cols-1">
              <div>
                <div className="flex flex-col items-center mt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2">
                    <div>
                      <p className="p-2 font-sans text-lg font-medium">
                        Gaucho is ... Anupam Kher
                      </p>
                      <p className="p-2 font-sans text-xl leading-normal">
        ...
        <div className="flex flex-col border-b mb-4 pb-6 lg:flex-row gap-2 ">
          <div className="directors">
            {/* for large view & desktop view lg, xl view */}
            <div className="border-r hidden lg:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1">
              <HoverCards
          ...
          <div className="producers">
            <div className="hidden lg:grid grid-cols-1 md:grid:cols-2 lg:grid-cols-2">
              {/* 1 */}
              <HoverCards
          ...
          <div className="writer">
            ...
            <div className="border-r hidden lg:grid grid-cols-1">
              <HoverCards
                h3headline="The Writer - Jairaj Padmanabhan"
                paragraphs={[

...
const Page = ({ searchParams }) => {
  ...
  const [amount, setAmount] = useState(searchParams.value || 10);
  ...
  // const tierNo = router.query;
  // const Inr = router.query;
              ...
              <>
                <div className="grid gap-1">
                  <div className="flex justify-between items-center ">
                    <p className="font-medium font-sans text-xl capitalize">
                      {post.tierNo}
                    </p>
                  ...
                  <div className="flex justify-between items-center ">
                    <p className="font-normal font-sans text-xl text-gray-500">
                      Qty : {qty}
                    </p>
                    <p className="font-normal font-sans text-xl text-gray-500">
                      Original : {post.Inr}
            ...
            <div className="grid gap-3">
              <div className="flex justify-between items-center ">
                ...
                <p className="font-semibold text-lg text-end">
                  ₹
                  {tierNo
                    ? `${Inr} + ${selectedOption || "425"} = ${
                        parseInt(selectedOption || "425") + Inr
                      }`
                    : "1,032"}
                </p>
              </div>

...
import youtube from "@/assets/donation-banner.webp";
import DonationBodyContent from "./DonationBodyContent";
import Modals from "./tiers/Modals";
import DefaultModal from "@/components/modals/DefaultModal";

const DonationBannerVideo = () => {
  ...
  return (
    <>
      <div className="relative bg-black">
            ...
            <div className="absolute inset-0">
              ...
              {/* <div className="absolute inset-0 transition-opacity duration-300">
                <iframe
                  width="100%"
                  height="100%"
                  // src="https://www.youtube.com/embed/gzaO_nMMRmw?si=gyEaAAcrhrMX4cKQ"
          ...
          <div className="relative w-full h-full flex justify-end items-center mx-auto max-w-7xl">
            <div className="max-w-[460px]">
              <div className="text-white px-6">
                {/* <p
                  className="leading-relaxed tracking-wide font-medium text-sm uppercase"
                ...
                <p
                  className="leading-relaxed tracking-wide font-normal font-sans text-xl"
                  data-cy="funding-status-heading"
                >
                  Your donation will ensure the Brihat Mridanga Trust gets the
                  film produced and widely released in theaters and other
                  traditional media. The Trust will also retain the rights for
                  making the film available for free screenings in Indian
                  schools, colleges, universities, and villages.
                </p>
              </div>
              <div className="px-6 mt-4">
                ...
                <p className="mt-4 px-1 mx-auto text-xs font-medium font-Whitney leading-tight tracking-none text-white">
        ...
        >
          <button
            title="play-video"
            name="play-video"
            className="block cursor-pointer text-white border-0 outline-none focus:outline-none opacity-50 hover:opacity-100 transition-opacity"
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to left, rgb(0, 0, 0) 256px, rgb(0 0 0 / 49%) 100%)",
        }}
      >
        <div className="text-black">
          <p className="text-sm leading-relaxed tracking-none text-white">
            <span className="tracking-wide uppercase">now funding </span>{" "}
          </p>
          <h2
            className="text-2xl text-white font-semibold leading-normal tracking-tighter md:text-4xl md:font-medium md:leading-normal md:tracking-tighter"
            data-cy="project-name-header"
          >
            Radha and the Great Rescue
          </h2>
      ...
      <div
        className="p-6 border-t border-b md:border border-gray-8 md:mx-6 md:rounded xl:hidden max-w-[960px] lg:mx-auto"
        style={{
          background:
            "linear-gradient(to left, rgb(0, 0, 0) 256px, rgb(0 0 0 / 49%) 100%)",
        }}
      >
        <p
          className="leading-relaxed mb-4 text-white tracking-wide font-normal font-sans text-xl"
          data-cy="funding-status-heading"
        >
          Your donation will ensure the Brihat Mridanga Trust gets the film
          produced and widely released in theaters and other traditional media.
          The Trust will also retain the rights for making the film available
          for free screenings in Indian schools, colleges, universities, and
          villages.
        </p>
        <div>
          <div className="w-full h-2 relative rounded-lg bg-white bg-opacity-30">
        ...
        <div className="mt-2 flex justify-between text-black">
          <div className="w-full flex md:block pr-1">
            <div>
              <div className="lg:mt-1">
                <div className="flex flex-col">
                  <div className="text-2xl text-white font-semibold leading-normal tracking-tighter sm:text-4xl sm:font-medium sm:leading-normal">
                    Rs.0
                  </div>
                  {/* <div className="text-sm text-white leading-relaxed tracking-none">
                    of Rs.618,000 max *
                  </div> */}
                </div>
              </div>
              <div className="mt-3">
                <div className="flex flex-row items-center text-sm md:text-md">
                  ...
                  <div className="caption-md text-white sm:caption-lg whitespace-nowrap capitalize text-xl leading-5">
                    0 people*
                  </div>
                </div>
              </div>
        ...
        <div>
          ...
          <button
            ...
            onClick={handleBackToProject}
            className="uppercase cursor-pointer focus:outline-none focus-visible:ring-1 leading-tight tracking-wide disabled:pointer-events-none transition-all duration-150 h-12 px-6 rounded block w-full mt-2 mx-auto bg-yellow-dark hover:bg-yellow-dark focus-visible:ring-yellow-dark-3 active:bg-yellow-dark-3 disabled:bg-yellow-dark-disabled text-core-white disabled:text-core-gray-500 "
          >
            Donate
          </button>
        </div>
      ...
      {/* Popup */}
      {/* {showPopup && <Modals btnCloseClick={closePopup} btnopen={showPopup} />} */}
...
export default DonationBannerVideo;

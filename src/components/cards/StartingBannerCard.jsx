...
const StartingBannerCard = ({
  ...
  return (
    <div
      ...
      // className={`${section}-box bg-gradient-radial-${section} from-rgba(${v1}, ${v2}, ${v3}, ${v4}) to-rgba(${v5}, ${v6}, ${v7}, ${v8}) px-3 py-6 md:px-11 md:py-8 xl:px-24 xl:py-12`}
    >
      <div className="flex flex-col items-start gap-8">
        <div className="flex flex-col items-start gap-3 md:gap-4">
          <h2 className="font-bold text-yellow-dark text-left text-3xl md:text-5xl xl:text-6xl font-WhitneySemibold not-italic capitalize md:leading-[76.8px]">
          ...
          <p className="text-justify text-white font-Whitney text-sm xl:text-lg not-italic font-medium leading-6 md:leading-9 xl:leading-10">
            {description}
          </p>
        </div>
        <a
...
export default StartingBannerCard;
